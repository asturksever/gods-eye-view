/**
 * Mapillary map-feature taxonomy, derived from the class names in
 * mapillary/mapillary_sprite_source (MIT). OBJECT_VALUES is the point-object
 * layer (`mly_map_feature_point`, property `value`); SIGN_VALUES is the
 * traffic-sign layer (`mly_map_feature_traffic_sign`). Sign values end in a
 * regional group suffix (`--g1`, `--g3`); a wildcard such as
 * `regulatory--stop--*` matches every regional variant of one sign.
 * Regenerate from the sprite repository rather than editing by hand.
 */
export const OBJECT_VALUES = Object.freeze([
  'construction--barrier--temporary',
  'construction--flat--crosswalk-plain',
  'construction--flat--driveway',
  'construction--flat--flat-driveway',
...
export const SIGN_VALUES = Object.freeze([
  ...
  'information--highway-directions--g1',
  ...
  'information--lane-control-intersections--g1',
  'information--lane-control-left-turn--g1',
  'information--lane-control-multiple-lanes--g1',
  'information--lane-control-multiple-lanes--g2',
  'information--lane-control-right-turn--g1',
  ...
  'information--pedestrians-only--g4',
  ...
  'information--turn-left--g1',
  'information--turn-left-ahead--g1',
  'information--turn-right--g1',
...
/** Sign values collapsed to their family (regional suffix removed), sorted. */
export const SIGN_FAMILIES = Object.freeze(
  [...new Set(SIGN_VALUES.map((value) => value.replace(/--g\d+$/, '')))].sort(),
);
